        ...
        <el-col :span="17">
            <div class="header-right">
                <el-row>
                        ...
                        <div>
                            ...
                            >
                                <el-input
                                    ...
                                    @focus="handleFocus"
                                    @blur="handleBlur"
                                    ><template v-if="atKeyFromAside" #prepend
                                        ><el-tag effect="dark">{{
                                            atKeyFromAside
                                        }}</el-tag></template
                                    >
                    ...
                    <el-col
                        :span="item.span"
                        v-for="item in navigate_options"
                        :key="item.text"
                    >
                        <div
                            :class="item.class"
...
export default {
    ...
    methods: {
        ...
        handleDropdownItemClick(command) {
            ...
            let newPage = window.open(
                '../../static/staticHtml/sonPage.html',
                'newSonPage'
            );
    ...
    created() {
        ...
        // 初始化时设置主题
        this.handleSwitchChange();
        // 监听PageAside的atKey点击事件，改变input的prepend样式
        this.$eventBus.on('asideClick', val => {
            this.atKeyFromAside = val;
        });
    },
};
</script>
